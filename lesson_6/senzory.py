...
#zakladni trik pracuje s tim, ze si muzeme vytvorit int z bytu, a ten pak prevest na bity
...
def precti_senzory():
    #na nasi stavebnici jsou vsechny senzory (az na ultrazvukovy) pripojeni pres tzv. IO expander
    ...
    #i2c.read ma dva alespon dva povinne parametery: https://microbit-micropython.readthedocs.io/en/latest/i2c.html
    ...
    #ze stranky 48 manualu jsem vykoukala v jakem poradi jsou senzory zapojene do IO expanderu
